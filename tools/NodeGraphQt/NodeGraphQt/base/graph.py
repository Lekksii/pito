...
class NodeGraph(QtCore.QObject):
    ...
    """
    pyqtSignal triggered when a node is created in the node graph.
    ...
    """
    pyqtSignal triggered when nodes have been deleted from the node graph.
    ...
    """
    pyqtSignal triggered when a node is clicked with the LMB.
    ...
    """
    pyqtSignal triggered when the node selection has changed.
    ...
    """
    pyqtSignal triggered when a node is double clicked and emits the node.
    ...
    """
    pyqtSignal triggered when a node port has been connected.
    ...
    """
    pyqtSignal triggered when a node port has been disconnected.
    ...
    """
    pyqtSignal is triggered when a property has changed on a node.
    ...
    """
    pyqtSignal is triggered when data has been dropped to the graph.
    ...
    """
    pyqtSignal is triggered when session has been changed.
